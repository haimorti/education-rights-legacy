...
def build():
    ...
    # The מערכת שעות + מימוש phases live in the separate 01b document.
...
if __name__=='__main__':
    open(os.path.join(HTMLDIR,'01a-application.html'),'w',encoding='utf-8').write(build())
    print("built 01a-application.html (bespoke)")
